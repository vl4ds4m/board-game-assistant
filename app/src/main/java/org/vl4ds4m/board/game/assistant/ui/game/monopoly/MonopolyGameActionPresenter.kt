...
import org.vl4ds4m.board.game.assistant.ui.game.component.BaseGameActionPresenter

class MonopolyGameActionPresenter : BaseGameActionPresenter() {
    override fun showAction(action: GameAction, players: Players): String {
        ...
        return super.showAction(action, players)
    }
}
